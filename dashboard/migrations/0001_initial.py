    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupation', models.CharField(choices=[('Agriculture', 'Agriculture'), ('Engineer', 'Engineer'), ('Teacher', 'Teacher'), ('Student', 'Student'), ('Doctor', 'Doctor'), ('Business', 'Business'), ('Housewife', 'Housewife'), ('Government Job', 'Government Job'), ('Private Job', 'Private Job'), ('Retired', 'Retired'), ('Foreign Employment', 'Foreign Employment'), ('Other', 'Other')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.CharField(choices=[('Father', 'Father'), ('Husband', 'Husband'), ('Father-In-Law', 'Father-In-Law'), ('Son', 'Son'), ('Daughter', 'Daughter'), ('Mother', 'Mother'), ('Mother-In-Law', 'Mother-In-Law'), ('Brother', 'Brother'), ('Sister', 'Sister'), ('Grandfather', 'Grandfather'), ('Grandmother', 'Grandmother'), ('Uncle', 'Uncle'), ('Aunt', 'Aunt'), ('Grandson', 'Grandson'), ('Granddaughter', 'Granddaughter'), ('Nephew', 'Nephew'), ('Niece', 'Niece'), ('Cousin', 'Cousin'), ('Other', 'Other')], max_length=30)),
                ('date_of_birth', nepali_datetime_field.models.NepaliDateField()),
                ...
                ('issued_date', nepali_datetime_field.models.NepaliDateField(blank=True, null=True)),
